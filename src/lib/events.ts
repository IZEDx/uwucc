...
export class CharEvent implements IEvent {
	...
	public static init(this: void, args: any[]): IEvent | null {
...
export class TurtleInventoryEvent implements IEvent {
	...
	public static init(this: void, args: any[]): IEvent | null {
		if (!(typeof args[0] === "string") || (args[0] as string) != "turtle_inventory")
			return null;
...
class SpeakerAudioEmptyEvent implements IEvent {
	...
	public static init(this: void, args: any[]): IEvent | null {
		if (!(typeof args[0] === "string") || (args[0] as string) != "speaker_audio_empty")
			return null;
...
class ComputerCommandEvent implements IEvent {
	...
	public static init(this: void, args: any[]): IEvent | null {
		if (!(typeof args[0] === "string") || (args[0] as string) != "computer_command")
			return null;
