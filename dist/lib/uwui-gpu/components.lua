...
function ____exports.If(props, ...)
    local children = {...}
    local ____opt_result_34
    if props ~= nil then
        ____opt_result_34 = props.condition
    end
    if ____opt_result_34 or props == true then
        return children
    else
        return {}
    end
